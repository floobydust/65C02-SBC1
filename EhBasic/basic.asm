...
;
      .word $FF48           	; byte in from C02BIOS (no waiting)
      .word $FF4E           	; byte out from C02BIOS
      .word $FF45           	; null load JMP for EhBASIC (Reserve)
      .word $FF45           	; null save JMP for EhBASIC (Reserve)
      .word $FF72             ; Warm start JMP for C02 Monitor
